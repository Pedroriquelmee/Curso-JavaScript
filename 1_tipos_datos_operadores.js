...
let resultadoMultiplicacion = "5" * 2;
console.log(resultadoMultiplicacion); // Muestra 10 (number)
...
let numeroAsignado = 10;
numeroAsignado += 5; // Equivale a numeroAsignado = numeroAsignado + 5
console.log(numeroAsignado); // Muestra 15
